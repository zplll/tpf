                ...
                return {
                    ...
                    template:'<div class="my-page">\
                            <div class="page">\
                             ...
                             <div class="goPage">\
                                 <span>第<input type="number" ng-model="pg.jumpPageNum"/>页</span>\
                                 <span> <a ng-click="jumpToPage()">GO</a></span>\
                             ...
                             <div ng-if="pg.showError" style="color: brown">请输入正确页码</div>\
                         </div>',
                    scope:{
                        pg:'='
                    },
